        ...
        <div style={styles.body}>
          ...
          {state === "available" && (
            <div style={styles.stateBox}>
              ...
              <div style={styles.stateSub}>A new version of XPMT is ready. Your data will be preserved.</div>
              <div style={styles.actions}>
                <button style={styles.btnGhost} onClick={onClose}>Later</button>
                <button style={styles.btnPrimary} onClick={installUpdate}>Install Update</button>
              </div>
            </div>
          )}
          {state === "downloading" && (
          ...
          {state === "done" && (
            <div style={styles.stateBox}>
              ...
              <button style={styles.btnPrimary} onClick={() => invoke("plugin:process|restart")}>
                Restart Now
              </button>
            </div>
          )}
          {state === "error" && (
            <div style={styles.stateBox}>
              ...
              <div style={styles.actions}>
                <button style={styles.btnGhost} onClick={onClose}>Close</button>
                <button style={styles.btnPrimary} onClick={checkUpdates}>Try Again</button>
              </div>
            </div>
          )}
        </div>
...
const styles: Record<string, React.CSSProperties> = {
  ...
  progressFill: { height:"100%", width:"60%", background:"linear-gradient(90deg,#6C3DB5,#4F8EF7)", borderRadius:3 },
};
